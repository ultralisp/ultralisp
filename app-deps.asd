(DEFSYSTEM "app-deps" :CLASS :PACKAGE-INFERRED-SYSTEM :DEPENDS-ON
 ("3bmd" "alexandria" "anaphora" "babel" "babel-streams" "bordeaux-threads"
  ...
  "cl-fad" "cl-gearman" "cl-inflector" "cl-interpol" "cl-markdown"
  "cl-mustache" "cl-ppcre" "cl-ppcre-unicode" "cl-reexport" "cl-store"
  ...
  "closure-common" "cxml" "cxml/dom" "cxml/klacks" "cxml/test" "cxml/xml" "dbi"
  "defmain" "defmain/defmain" "dexador" "dissect" "documentation-utils"
  "drakma" "dynamic-classes" "esrap" "external-program" "f-underscore"
  ...
  "quri" "routes" "rutils" "salza2" "serapeum" "simple-inferiors" "slynk"
