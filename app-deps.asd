(DEFSYSTEM "app-deps" :CLASS :PACKAGE-INFERRED-SYSTEM :DEPENDS-ON
 ("3bmd" "alexandria" "anaphora" "babel" "babel-streams" "bordeaux-threads"
  ...
  "cl-markdown" "cl-mustache" "cl-ppcre" "cl-ppcre-unicode" "cl-reexport"
  "cl-store" "cl-strings" "cl-syntax" "cl-syntax-annot" "cl-unicode"
  "cl-unicode/base" "cl-utilities" "cl-yandex-metrika" "clack" "clack-socket"
  "closer-mop" "closure-common" "cxml" "cxml/dom" "cxml/klacks" "cxml/test"
  ...
  "lisp-namespace" "local-time" "local-time-duration" "log4cl" "log4cl-json"
  "lparallel" "mailgun" "mailgun/core" "metabang-bind" "metacopy"
  "metatilities" "metatilities-base" "mito" "mito-core" "mito-migration"
  ...
  "quicklisp" "quri" "routes" "rutils" "salza2" "serapeum" "simple-inferiors"
  "slynk" "smart-buffer" "spinneret" "spinneret/cl-markdown" "split-sequence"
  "static-vectors" "str" "string-case" "swap-bytes" "sxql" "symbol-munger"
